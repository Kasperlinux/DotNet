...
{
    public class ApplicantAlliedController : Controller
    {
        private readonly DhsMagacoursesContext context;
        private readonly IWebHostEnvironment environment;
        private readonly ILogger<ApplicantAnmController> _logger;

        public ApplicantAlliedController(DhsMagacoursesContext context, IWebHostEnvironment environment, ILogger<ApplicantAnmController> logger)
        {
        ...
        [HttpPost]
        public IActionResult Create(AlliedViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var dataBase = new ApplicantsAlliedCourse()
                {
                    ...
                    MarksMathematicsTheory=model.MarksMathematicsTheory,
                    MarksMathematicsPractical=model.MarksMathematicsPractical,
                    FullmarksMathematics=model.FullmarksMathematics,
                    ...
                    PercentagePcmXii=model.PercentagePcmXii,
        ...
        {
            var applicants = context.ApplicantsAlliedCourses.ToList();
