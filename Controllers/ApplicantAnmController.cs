...
{
    public class ApplicantAnmController : Controller
    {
        private readonly DhsMagacoursesContext context;
        private readonly IWebHostEnvironment environment;
        private readonly ILogger<ApplicantAnmController> _logger;

        public ApplicantAnmController(DhsMagacoursesContext context, IWebHostEnvironment environment, ILogger<ApplicantAnmController> logger)
        {
        ...
        public IActionResult Create(ImageModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var dataBase = new ApplicantsAnm()
                {
        ...
        {
            var applicants = context.ApplicantsAnms.ToList(); 
